    ...
    <div className='h-screen overflow-hidden relative flex justify-center items-center'>
        ...
        <div className='absolute flex-col mt-36'>
          ...
          <div className='flex flex-row mt-16 justify-evenly'>
            <a href="https://www.linkedin.com/in/ethanyip/" target="_blank" rel="noopener"><img src={linkedin} className='w-20'/></a>
            <a href="https://github.com/itsyefan" target="_blank" rel="noopener"><img src={github} className='w-20'/></a>
            <a href="https://leetcode.com/itsyefan/" target="_blank" rel="noopener"><img src={leetcode} className='w-20'/></a>
          </div>
        </div>
